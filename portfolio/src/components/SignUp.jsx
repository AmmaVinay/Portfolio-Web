            ...
            <div className="max-w-md w-full bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="py-8 px-6">
                    <div className="mb-6">
                        ...
                        <input id="name" name="name" type="text" className="peer placeholder-gray-400 placeholder-opacity-50 h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Enter your full name" />
                    </div>

                    <div className="mb-6">
                        <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">Email Address</label>
                        <input id="email" name="email" type="text" className="peer placeholder-gray-400 placeholder-opacity-50 h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Enter your email address" />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="password" className="block text-gray-700 text-sm font-bold mb-2">Password</label>
                        <input id="password" name="password" type="password" className="peer placeholder-gray-400 placeholder-opacity-50 h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Enter your password" />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="confirm-password" className="block text-gray-700 text-sm font-bold mb-2">Confirm Password</label>
                        <input id="confirm-password" name="confirm-password" type="password" className="peer placeholder-gray-400 placeholder-opacity-50 h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600" placeholder="Confirm your password" />
                    </div>
                    ...
                    <div className="mt-4 text-center">
                        Already have an account? <Link to="/login" className="text-cyan-500 hover:underline">Sign In</Link>
                    </div>
                </div>
            </div>
        </div>
